...
#ifdef DWAVDAPI_SUPPORT_XMLAPI_31    
    php_info_print_table_row(2, "Supported version of Dr.Web AV-Desk XML API", "3.0.x; 3.1.x");
#else
    php_info_print_table_row(2, "Supported version of Dr.Web AV-Desk XML API", "3.0.x");
#endif        
...
PHP_FUNCTION(dwavd_set_ssl_crt) {
    ...
    if(0 < value_len) {
        ...
        if(DWAVDAPI_FAILURE == dwavdapi_set_connect_ssl_crt(handle, NULL)){
